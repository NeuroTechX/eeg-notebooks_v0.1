...
mywin = visual.Window([1600, 900], monitor='testMonitor', units='deg',
                      fullscr=True)
faces = list(map(load_image, glob('stimulus_presentation/stim/face_house/faces/*_3.jpg')))
houses = list(map(load_image, glob('stimulus_presentation/stim/face_house/houses/*.3.jpg')))
