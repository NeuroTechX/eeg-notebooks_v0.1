...
parser.add_option("-d", "--duration", dest="duration", type='int',
                  default=400, help="duration of the recording in seconds.")
parser.add_option("-s", "--subjects", dest="subject",
                  type='str', default='subjTEST', help="subject ID")
...
params = {
    ...
    'stimDur': .8,             # time when stimulus is presented (in seconds)
...
n_trials = int((options.duration - params['tStartup'] -
...
outname = outdir + 'behav_' + options.subject + \
    '_run' + str(options.run) + '.mat'
